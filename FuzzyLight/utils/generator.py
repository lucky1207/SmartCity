...
from .cityflow_env import CityFlowEnv, Intersection
import time
import os
import copy
...
class Generator:
    ...
    def generate(self):
        ...
        #while step_time < 50:
            ...
            if "IS_CONTINOUS" in self.dic_traffic_env_conf.keys():
                is_continous = self.dic_traffic_env_conf["IS_CONTINOUS"]
            else:
                is_continous = False
            ...
            if is_continous:
                ...
                for i in list_need:
                    ...
                    if intersection.current_phase_index != (phase_action[idx] + 1):
                        duration_action[idx] = max(duration_action[idx], self.dic_traffic_env_conf["YELLOW_TIME"])
                    idx += 1
            
            next_state, step_time, list_need = self.env.step(phase_action, duration_action, is_continous)
